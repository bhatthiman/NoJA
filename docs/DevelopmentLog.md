...
- Kept nozzle angle in the XZ plane so Y offset translates the nozzle without adding a Y-direction angular component, and extended zero-inside-projection trim stock so angled fish-mouth edges reach the shell ID.
